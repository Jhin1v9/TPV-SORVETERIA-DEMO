...
export const produtosFixos: ProdutoFixo[] = [
  // COPAS
  {
    ...
    preco: 8.10,
    imagem: 'https://images.unsplash.com/photo-1563805042-7684c484e4b8?w=600',
  ...
  },
  {
    ...
    preco: 9.10,
    imagem: 'https://images.unsplash.com/photo-1558326332-6d4db0c968fd?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'gluten', nivel: 'contem' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }, { alergeno: 'ovos', nivel: 'pode_conter' }],
    categoria: 'copas',
    emEstoque: true,
  },
  {
    ...
    preco: 9.30,
    imagem: 'https://images.unsplash.com/photo-1541783245831-57d6fb0926d3?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'gluten', nivel: 'contem' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }, { alergeno: 'ovos', nivel: 'pode_conter' }],
    categoria: 'copas',
    emEstoque: true,
  },
  {
    ...
    preco: 8.30,
    imagem: 'https://images.unsplash.com/photo-1570197788417-0e82375c9371?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'gluten', nivel: 'contem' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }, { alergeno: 'ovos', nivel: 'pode_conter' }],
    categoria: 'copas',
    emEstoque: true,
  },
  {
    ...
    preco: 9.30,
    imagem: 'https://images.unsplash.com/photo-1505253758473-96b701d2cd03?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'gluten', nivel: 'contem' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }, { alergeno: 'ovos', nivel: 'pode_conter' }],
    categoria: 'copas',
    emEstoque: true,
  },
  {
    ...
    preco: 8.50,
    imagem: 'https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'gluten', nivel: 'contem' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }, { alergeno: 'ovos', nivel: 'pode_conter' }],
    categoria: 'copas',
    emEstoque: true,
  },
  {
    ...
    preco: 15.30,
    imagem: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'gluten', nivel: 'contem' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }, { alergeno: 'ovos', nivel: 'pode_conter' }],
    categoria: 'copas',
    emEstoque: true,
  ...
  },
  {
    ...
    preco: 8.40,
    imagem: 'https://images.unsplash.com/photo-1477506252414-b2954dbdadb4?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'gluten', nivel: 'contem' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }, { alergeno: 'ovos', nivel: 'pode_conter' }],
    categoria: 'copas',
    emEstoque: true,
  },
  {
    ...
    preco: 8.00,
    imagem: 'https://images.unsplash.com/photo-1495278096736-c1626b6909ac?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'gluten', nivel: 'contem' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }, { alergeno: 'ovos', nivel: 'pode_conter' }],
    categoria: 'copas',
    emEstoque: true,
  },
  ...
  // SOUFFLÉ
  {
    ...
    preco: 7.10,
    imagem: 'https://images.unsplash.com/photo-1624353365286-3f8d62daad51?w=600',
  ...
  // BANANA SPLIT
  {
    ...
    preco: 12.30,
    imagem: 'https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?w=600',
  ...
  // CAFÉS Y BEBIDAS
  { id: 'cafe', nome: t('Café', 'Cafè', 'Café', 'Coffee'), preco: 1.80, imagem: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-largo', nome: t('Café Largo', 'Cafè Llarg', 'Café Longo', 'Long Coffee'), preco: 1.90, imagem: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-hielo', nome: t('Café con Hielo', 'Cafè amb Gel', 'Café com Gelo', 'Iced Coffee'), preco: 2.30, imagem: 'https://images.unsplash.com/photo-1517701604599-bb29b5dd7359?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-leche', nome: t('Café con Leche', 'Cafè amb Llet', 'Café com Leite', 'Coffee with Milk'), preco: 2.00, imagem: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-leche-hielo', nome: t('Café Leche + Hielo', 'Cafè Llet + Gel', 'Café Leite + Gelo', 'Iced Latte'), preco: 2.40, imagem: 'https://images.unsplash.com/photo-1517701604599-bb29b5dd7359?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cortado', nome: t('Cortado', 'Cortat', 'Cortado', 'Cortado'), preco: 1.90, imagem: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cortado-hielo', nome: t('Cortado + Hielo', 'Cortat + Gel', 'Cortado + Gelo', 'Iced Cortado'), preco: 2.30, imagem: 'https://images.unsplash.com/photo-1517701604599-bb29b5dd7359?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'americano', nome: t('Americano', 'Americà', 'Americano', 'Americano'), preco: 2.10, imagem: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'americano-hielo', nome: t('Americano + Hielo', 'Americà + Gel', 'Americano + Gelo', 'Iced Americano'), preco: 2.50, imagem: 'https://images.unsplash.com/photo-1517701604599-bb29b5dd7359?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'capuccino', nome: t('Capuccino', 'Caputxino', 'Capuccino', 'Cappuccino'), preco: 2.80, imagem: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-helado', nome: t('Café + Helado', 'Cafè + Gelat', 'Café + Sorvete', 'Coffee + Ice Cream'), preco: 2.90, imagem: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'te', nome: t('Té', 'Te', 'Chá', 'Tea'), preco: 2.00, imagem: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'te-hielo', nome: t('Té + Hielo', 'Te + Gel', 'Chá + Gelo', 'Iced Tea'), preco: 2.50, imagem: 'https://images.unsplash.com/photo-1517701604599-bb29b5dd7359?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cacaolat', nome: t('Cacaolat', 'Cacaolat', 'Cacaolat', 'Chocolate Milk'), preco: 2.20, imagem: 'https://images.unsplash.com/photo-1549007994-cb92caebd54b?w=600', alergenos: [{ alergeno: 'leite', nivel: 'contem' }], categoria: 'cafes', emEstoque: true },
  { id: 'agua', nome: t('Agua', 'Aigua', 'Água', 'Water'), preco: 1.30, imagem: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600', alergenos: [], categoria: 'cafes', emEstoque: true },
  { id: 'agua-gas', nome: t('Agua con Gas', 'Aigua amb Gas', 'Água com Gás', 'Sparkling Water'), preco: 2.30, imagem: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600', alergenos: [], categoria: 'cafes', emEstoque: true },
  { id: 'zumo', nome: t('Zumo', 'Suc', 'Suco', 'Juice'), preco: 2.00, imagem: 'https://images.unsplash.com/photo-1613478223719-2ab802602423?w=600', alergenos: [], categoria: 'cafes', emEstoque: true },
  { id: 'refresco', nome: t('Refresco', 'Refresc', 'Refrigerante', 'Soft Drink'), preco: 2.20, imagem: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=600', alergenos: [], categoria: 'cafes', emEstoque: true },
  { id: 'nestea', nome: t('Nestea', 'Nestea', 'Nestea', 'Nestea'), preco: 2.40, imagem: 'https://images.unsplash.com/photo-1517701604599-bb29b5dd7359?w=600', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
];
...
export const produtosPersonalizaveis: ProdutoPersonalizavel[] = [
  // AÇAÍ
  {
    ...
    precoBase: 7.90,
    imagem: 'https://images.unsplash.com/photo-1617225827592-d20989e9fe61?w=600',
  ...
  // CONOS
  {
    ...
    precoBase: 3.50,
    imagem: 'https://images.unsplash.com/photo-1623595119708-26b1f2a845d7?w=600',
  ...
  // GOFRES
  {
    ...
    precoBase: 4.90,
    imagem: 'https://images.unsplash.com/photo-1562376552-ef082f0f7815?w=600',
  ...
  // GRANIZADO YOGURT
  {
    ...
    precoBase: 4.80,
    imagem: 'https://images.unsplash.com/photo-1504113888839-1e515e200149?w=600',
    alergenos: [{ alergeno: 'sulfitos', nivel: 'pode_conter' }],
    categoria: 'granizados',
    emEstoque: true,
    opcoes: {
  ...
  // BATIDOS
  {
    ...
    precoBase: 5.80,
    imagem: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=600',
    alergenos: [{ alergeno: 'leite', nivel: 'contem' }, { alergeno: 'soja', nivel: 'pode_conter' }, { alergeno: 'frutos_casca_rija', nivel: 'pode_conter' }],
    categoria: 'batidos',
    emEstoque: true,
    opcoes: {
  ...
  // ORXATA / LLET MERENGADA
  {
    ...
    precoBase: 4.20,
    imagem: 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=600',
