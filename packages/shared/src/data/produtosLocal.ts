...
export const produtosFixos: ProdutoFixo[] = [
  ...
  // CAFÉS Y BEBIDAS
  { id: 'cafe', nome: t('Café', 'Cafè', 'Café', 'Coffee'), preco: 1.80, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-largo', nome: t('Café Largo', 'Cafè Llarg', 'Café Longo', 'Long Coffee'), preco: 1.90, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-hielo', nome: t('Café con Hielo', 'Cafè amb Gel', 'Café com Gelo', 'Iced Coffee'), preco: 2.30, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-leche', nome: t('Café con Leche', 'Cafè amb Llet', 'Café com Leite', 'Coffee with Milk'), preco: 2.00, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-leche-hielo', nome: t('Café Leche + Hielo', 'Cafè Llet + Gel', 'Café Leite + Gelo', 'Iced Latte'), preco: 2.40, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cortado', nome: t('Cortado', 'Cortat', 'Cortado', 'Cortado'), preco: 1.90, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cortado-hielo', nome: t('Cortado + Hielo', 'Cortat + Gel', 'Cortado + Gelo', 'Iced Cortado'), preco: 2.30, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'americano', nome: t('Americano', 'Americà', 'Americano', 'Americano'), preco: 2.10, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'americano-hielo', nome: t('Americano + Hielo', 'Americà + Gel', 'Americano + Gelo', 'Iced Americano'), preco: 2.50, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'capuccino', nome: t('Capuccino', 'Caputxino', 'Capuccino', 'Cappuccino'), preco: 2.80, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cafe-helado', nome: t('Café + Helado', 'Cafè + Gelat', 'Café + Sorvete', 'Coffee + Ice Cream'), preco: 2.90, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'te', nome: t('Té', 'Te', 'Chá', 'Tea'), preco: 2.00, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'te-hielo', nome: t('Té + Hielo', 'Te + Gel', 'Chá + Gelo', 'Iced Tea'), preco: 2.50, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
  { id: 'cacaolat', nome: t('Cacaolat', 'Cacaolat', 'Cacaolat', 'Chocolate Milk'), preco: 2.20, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'contem' }], categoria: 'cafes', emEstoque: true },
  { id: 'agua', nome: t('Agua', 'Aigua', 'Água', 'Water'), preco: 1.30, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [], categoria: 'cafes', emEstoque: true },
  { id: 'agua-gas', nome: t('Agua con Gas', 'Aigua amb Gas', 'Água com Gás', 'Sparkling Water'), preco: 2.30, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [], categoria: 'cafes', emEstoque: true },
  { id: 'zumo', nome: t('Zumo', 'Suc', 'Suco', 'Juice'), preco: 2.00, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [], categoria: 'cafes', emEstoque: true },
  { id: 'refresco', nome: t('Refresco', 'Refresc', 'Refrigerante', 'Soft Drink'), preco: 2.20, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [], categoria: 'cafes', emEstoque: true },
  { id: 'nestea', nome: t('Nestea', 'Nestea', 'Nestea', 'Nestea'), preco: 2.40, imagem: '/assets/demo/categoria-copo300.jpg', alergenos: [{ alergeno: 'leite', nivel: 'pode_conter' }], categoria: 'cafes', emEstoque: true },
];
