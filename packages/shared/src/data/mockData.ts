...
export const pedidosMock: Pedido[] = [
  ...
  // ─── Pedidos no formato novo (produtos) ───
  {
    id: 'p-011',
    numeroSequencial: 11,
    status: 'preparando',
    timestampCriacao: '2026-04-18T14:30:00',
    timestampListo: null,
    metodoPago: 'tarjeta',
    subtotal: 8.91,
    descuento: 0,
    ...
    itens: [
      {
        id: 'i-011',
        itemType: 'product',
        productId: 'copa-bahia',
        productName: 'Copa Bahia',
        productSnapshot: {
          id: 'copa-bahia',
          nome: { es: 'Copa Bahia', ca: 'Copa Bahia', pt: 'Copa Bahia', en: 'Bahia Cup' },
          preco: 8.10,
          imagem: '/assets/demo/categoria-copo500.jpg',
          categoriaId: 'copas',
          emEstoque: true,
  ...
  },
  {
    ...
    numeroSequencial: 12,
    status: 'pendiente',
    timestampCriacao: '2026-04-18T14:45:00',
    timestampListo: null,
    metodoPago: 'bizum',
    subtotal: 8.09,
    descuento: 0,
    ...
    itens: [
      {
        ...
        productSnapshot: {
          id: 'acai',
          nome: { es: 'Açaí', ca: 'Açaí', pt: 'Açaí', en: 'Açaí' },
          precoBase: 7.90,
          imagem: '/assets/demo/categoria-copo500.jpg',
          categoriaId: 'acai',
          emEstoque: true,
        ...
        selections: {
          tamanhos: [{ id: 'acai-mitja', nome: { es: 'Mitjà — 3 toppings + 2 frutas', ca: 'Mitjà', pt: 'Médio', en: 'Medium' }, preco: 8.90, tipo: 'tamanho' }],
          toppings: [{ id: 'top-granola', nome: { es: 'Granola', ca: 'Granola', pt: 'Granola', en: 'Granola' }, preco: 0, tipo: 'topping', emoji: '🌾' }],
          frutas: [{ id: 'fruta-maduixa', nome: { es: 'Fresa', ca: 'Maduixa', pt: 'Morango', en: 'Strawberry' }, preco: 0, tipo: 'fruta', emoji: '🍓' }],
        },
        categoriaSku: 'acai',
        categoriaNome: 'Açaí',
        sabores: [],
  ...
  },
  {
    ...
    numeroSequencial: 13,
    status: 'listo',
    timestampCriacao: '2026-04-18T15:00:00',
    timestampListo: '2026-04-18T15:08:00',
    metodoPago: 'efectivo',
    subtotal: 11.00,
    descuento: 0,
    extras: 0,
    ...
    itens: [
      {
        id: 'i-013',
        itemType: 'product',
        productId: 'cafe-leche',
        productName: 'Café con Leche',
        productSnapshot: {
          id: 'cafe-leche',
          nome: { es: 'Café con Leche', ca: 'Cafè amb Llet', pt: 'Café com Leite', en: 'Coffee with Milk' },
          preco: 2.00,
          imagem: '/assets/demo/categoria-copo300.jpg',
          categoriaId: 'cafes',
          emEstoque: true,
      ...
      },
      {
        ...
        itemType: 'product',
        productId: 'copa-oreo',
        productName: 'Copa Oreo',
        productSnapshot: {
          id: 'copa-oreo',
          nome: { es: 'Copa Oreo', ca: 'Copa Oreo', pt: 'Copa Oreo', en: 'Oreo Cup' },
          preco: 9.10,
          imagem: '/assets/demo/categoria-copo500.jpg',
          categoriaId: 'copas',
          emEstoque: true,
