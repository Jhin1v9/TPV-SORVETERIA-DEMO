    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 z-10">
        ...
        <div className="flex justify-between items-center px-4 py-2">
          ...
          {/* KIMI REVISAO OK TESTE EXAUSTIVO PRA PROCURAR BUGS — skip button agora visível com contraste, borda e fundo */}
          <button
            onClick={onSkip}
            className="rounded-full border border-white/18 bg-white/10 px-3 py-1.5 text-xs font-semibold text-white/85 shadow-sm backdrop-blur-sm transition-all hover:bg-white/16 hover:text-white"
          >
            {t.skip}
          </button>
        </div>
